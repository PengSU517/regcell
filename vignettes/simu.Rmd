...
# result2$method = factor(result2$method, levels = c("CR-Lasso", "SSS", "RLars", "MM-Lasso", "SLTS", "Lasso", "CR-Lasso_old", "Lasso_old"))
...
# names = paste("plot_rmspe_rowwise_p",unique(result3$p), ".eps", sep = "")
...
summ = summary[,c("e", "df", "method", "F1")]
# summm = spread(summ, key = method, value = F1)
# summm[,-(1:2)] = round(summm[,-(1:2)],2)
# knitr::kable(summm, format = "latex")
```
...
# names = paste("plot_tpr_rowwise_p",unique(result3$p), ".eps", sep = "")
...
# names = paste("plot_fpr_rowwise_p",unique(result3$p), ".eps", sep = "")
# ggsave(names, plot = p2, width = 10,height = 7)
```
...
# names = paste("plot_f1_rowwise_p",unique(result3$p), ".eps", sep = "")
# ggsave(names, plot = p2, width = 10,height = 7)
```
