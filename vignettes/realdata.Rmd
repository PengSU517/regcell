...
saveRDS(result_realdata_artificial, file = "result_realdata_artificial.rds")
...
saveRDS(result_realdata, file = "result_realdata.rds")
...
```{r, fig.height=6, fig.width=10, fig.cap= "Leave-one-out prediction residuals of the Bone mineral density data", eval = FALSE}
