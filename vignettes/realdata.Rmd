...
library(tidyverse)
library(janitor)
# remotes::install_github("esmucler/mmlasso")
library(mmlasso)
...
##### methods compared
mtds = list(
  ## sparse shooting S, codes are from https://github.com/ineswilms/sparse-shooting-S 
  ## compiled into a package available from https://github.com/PengSU517/shootings
  ...
  # effectively replaced by the pense package on CRAN
  
  ## sparse LTS, from package robustHD
  slts = function(y,x){regcell::sparseLTS(y,x)$betahat},
