...
cellWise::cellMap(
  t(x),
  columnlabels = c(1,rep(" ",dim(x)[1]-2),dim(x)[1]),
  rowlabels = c(1,rep(" ",dim(x)[2]-2),dim(x)[2]),
  columnangle = 0,
  rowtitle = "Genes", columntitle = "Observations",
  sizetitles = 2,
  adjustrowlabels = 0.5,
...
Among the observations, the thirteenth observation shows the highest contamination rate at $22\%$.
